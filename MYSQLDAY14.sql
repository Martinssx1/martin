...
select device_brand,os,ram from device where (5g = 'no'or front_camera_mp>=16) or (ram = 6);
select device_brand,os,ram from device where 5g is not null;
select device_brand,os,ram from device where 5g is null;
select device_brand,os,ram,days_used from device where days_used between 200 and 350;
select device_brand,os,ram from device where ram in (3,6,8);
select distinct device_brand from device;
select device_brand,os,ram from device where device_brand like 'M%';
select device_brand,os,ram from device where device_brand like '%a';
select device_brand,os,ram from device where device_brand like '__a%';
...
select device_brand,avg(ram)as average from device group by device_brand;
